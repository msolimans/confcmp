...
func newPackageManager(p1, p2 []byte) (error, *YmlManager) {
	...
	return nil, &YmlManager{con, comparison.GetInstance()} //2 packages, in case we need more in future
...
func (self *YmlManager) Compare() (error, bool) {
